package com.fudn.chapter2_ex1.aspects;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.fudn.chapter2_ex1.services.StudentServiceImpl.save(..))")
    ...
    @After("execution(* com.fudn.chapter2_ex1.services.StudentServiceImpl.save(..))")
